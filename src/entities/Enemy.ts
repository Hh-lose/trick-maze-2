...
export class Enemy {
  ...
  hurt(amount: number, burn = false): boolean { this.hp -= amount; this.hitFlash = 90; if (burn) this.burn = Math.max(this.burn, 2000); if (this.hp <= 0) { this.alive = false; this.sprite.destroy(); return true; } return false; }
}
